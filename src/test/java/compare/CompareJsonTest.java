...
public class CompareJsonTest {
    ...
    public void compareJsonTest(){
        ...
        Assert.assertEquals("Error!",true, CompareJsonSol.areEqualJson(expectResultJson,actualResultJson));
    ...
    public void compareJsonTest2(){
        ...
        Assert.assertEquals("Error!",false, CompareJsonSol.areEqualJson(expectResultJson,actualResultJson));
